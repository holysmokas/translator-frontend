...
(function () {
    ...
    function updatePlanDisplay(data) {
        ...
        // Usage display
        const trialUsed = data.profile?.trial_used === true;
        ...
        if (data.usage && data.limits) {
            ...
            if (roomsLimit === -1) {
                ...
                elements.planUsage.style.color = '';
            } else if (tier === 'trial' && trialUsed) {
                // Trial user who has used their trial
            ...
            // Fallback: if no usage data but trial is marked as used
            elements.planUsage.textContent = 'Trial used';
            elements.planUsage.style.color = '#ef4444';
        }
