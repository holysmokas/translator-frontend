...
================================`;
    ...
    function showRoomUI(videoUrl) {
        ...
        // Join Daily room with SDK - tiles will be added to the same videoGrid
        if (videoUrl && typeof joinDailyRoom === 'function') {
    ...
    function renderFilesList() {
        ...
        elements.filesList.innerHTML = state.roomFiles.map(file => {
            ...
            const canDelete = file.user_id === state.user.id;
            ...
            return `
                <div class="file-item" data-file-id="${file.id}">
                    ...
                    <div class="file-actions">
                        ...
                        ${canDelete ? `
                            <button class="file-action-btn delete" onclick="deleteSharedFile('${file.id}')" title="Delete">
                                🗑️
                            </button>
                        ` : ''}
                    </div>
