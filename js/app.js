...
(function() {
    ...
    function updateMicButton() {
        ...
        if (state.isListening) {
            ...
            btn.querySelector('.control-label').textContent = 'Voice On';
        } else {
            btn.classList.remove('active');
            btn.querySelector('.control-icon').textContent = '🗣️';
            btn.querySelector('.control-label').textContent = 'Voice Off';
        }
    }
    ...
    function disconnectRoom() {
        ...
        if (elements.startVoiceBtn) {
            ...
            elements.startVoiceBtn.querySelector('.control-label').textContent = 'Voice Off';
        }
